---
ID: 15473
post_title: Terry Hillsberg
author: admin
post_excerpt: ""
layout: post
permalink: >
  http://nextgenius.com.au/index.php/entrepreneur-mentoring/
published: true
post_date: 2018-03-11 15:53:03
---
<script src="http://rawgit.com/ethereum/web3.js/0.16.0/dist/web3.min.js"><span data-mce-type="bookmark" style="display: inline-block; width: 0px; overflow: hidden; line-height: 0;" class="mce_SELRES_start">﻿</span></script>
...
<div class="column">
<ul>
 	<li>Graduated from the University of Sydney, Australia, in mathematics, computer science and economics</li>
 	<li>Was CIO/CTO for a large Australian Government agency</li>
 	<li>Served as a senior Australian government official in innovation and trade related policyroles</li>
 	<li>Became an angel and venture capital fund manager in 1988</li>
 	<li>Raised two venture funds - JAVCF and Apple Development Fund</li>
 	<li>Established first business in China in 1995</li>
 	<li>Has invested in and realised gains from a number of companies that have subsequentlybeen listed on the NYSE, NASDAQ, and ASX</li>
 	<li>Was founder of 6 companies, 3 of which were successful</li>
 	<li>Of recent times has been focussing upon investment in early stage digital token networks</li>
...
<a href="" onclick="Calendly.showPopupWidget('https://calendly.com/info-3648');return false;">Schedule time with me</a>
