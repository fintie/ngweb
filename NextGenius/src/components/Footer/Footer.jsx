          ...
          <GridItem xs={12} sm={12} md={4}>
            <div className={classes.center}>
              <List className={classes.list}>
                ...
                <ListItem className={classes.inlineBlock}>
                  <Button component={Link} to="/events" color="transparent" simple>
                    Events
                  </Button>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <Button component={Link} to="/blog" color="transparent" simple>
                    Blog
                  </Button>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <Button component={Link} to="/faq" color="transparent" simple>
                    FAQ
                  </Button>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
                  <Button component={Link} to="/about" color="transparent" simple>
                    About
                  </Button>
                </ListItem>
                <ListItem className={classes.inlineBlock}>
